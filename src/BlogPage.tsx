    ...
    <div className="pt-32 min-h-screen bg-ocean-deep">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            בלוג <span className="text-gold">הפלגות</span>
          </motion.h1>
          <p className="text-pearl/60 text-xl max-w-2xl mx-auto mb-10">
            כל מה שצריך לדעת על עולם הקרוזים: טיפים, המלצות, וסיפורי מסע מהיעדים היפים בעולם.
          </p>

          <div className="max-w-md mx-auto relative mb-20">
            <input 
              type="text" 
              placeholder="חפש בכתבות..."
              value={filter}
              onChange={(e) => setFilter(e.target.value)}
              className="w-full bg-white/5 border border-white/10 rounded-full py-4 px-12 focus:outline-none focus:border-gold transition-all text-center"
            />
        ...
        {!filter && (
          <motion.div
            ...
            className="mb-20"
          >
            <Link to={`/blog/${featuredPost.id}`} className="group relative block h-[500px] rounded-[48px] overflow-hidden shadow-2xl">
              <img 
              ...
              <div className="absolute bottom-0 left-0 right-0 p-12 md:p-20">
                <div className="flex items-center gap-4 text-gold text-sm font-bold mb-6 uppercase tracking-widest">
                  <span className="bg-gold text-ocean-deep px-3 py-1 rounded-full text-[10px]">מומלץ</span>
