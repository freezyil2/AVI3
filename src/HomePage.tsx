...
import CruiseQuiz from './components/CruiseQuiz';
...
export default function HomePage() {
  ...
  const shipsToShow = showAllShips ? filteredShips : filteredShips.slice(0, 5);
        ...
        <div className="container mx-auto px-6">
          ...
          {filteredShips.length > 5 && (
            <div className="mt-16 text-center">
              ...
              >
                {showAllShips ? 'הצג פחות' : `צפה בכל הצי (${filteredShips.length} אוניות)`}
              </button>
            </div>
          )}
        </div>
